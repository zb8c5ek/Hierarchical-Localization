...
def process_dataset(args, dataset_name):
    ...
    subprocess.check_call(
        [
            os.path.realpath(args.colmap_path),     # colmap path should be able to be retrieved from PyCOLMAP
...
def parse_args():
    ...
    parser.add_argument("--dataset_names", required=True)    # Default Required
    # Datasets can be downloaded at: https://www.eth3d.net/datasets
